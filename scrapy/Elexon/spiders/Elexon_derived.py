...
from Elexon.items import derived
import os
from datetime import date, timedelta
from dateutil.parser import parse


class derived_spider(XMLFeedSpider):
...
#   ]
    ...
    custom_settings = {
        'FEED_FORMAT': 'csv',
        'FEED_URI': '../Main/csv/Elexon_derived_%(STARTDATE)s.csv'
    }
    ...
    def __init__(self, *args, **kwargs):
        ...
        if os.path.exists('../Main/csv/Elexon_derived_' + self.STARTDATE + '.csv'):
